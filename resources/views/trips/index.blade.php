                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-auto">
                                                    ...
                                                    <button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModalgrid">
                                                        <i class="ri-add-line align-bottom me-1"></i>Add New Trips
                                                    </button>
                                                        ...
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <form action="{{route('trips.store')}}" method="POST" id="createproduct-form" autocomplete="off" class="needs-validation">
                                                                        @csrf

                                                                        <div class="row g-3">
                                                                            <div class="col-xxl-6">
                                                                                <div>
                                                                                    <input type="hidden" name="transection_no"  class="form-control" >
                                                                            ...
                                                                            <div class="col-xxl-6">
                                                                                <div>
                                                                                    <label for="lastName" class="form-label">Bus Name</label>
                                                                                    <select name="bus_id" class="form-select" required aria-label="select example">
                                                                            ...
                                                                            <div class="col-xxl-6">
                                                                                <div>
                                                                                    <label for="lastName" class="form-label">Location from</label>
                                                                                    <select name="location_id_from" class="form-select" required aria-label="select example">
                                                                                        <option >Select the location from</option>
                                                                            ...
                                                                            <div class="col-xxl-6">
                                                                                <div>
                                                                                    <label for="lastName" class="form-label">Location to</label>
                                                                                    <select name="location_id_to" class="form-select" required aria-label="select example">
                                                                                        <option >Select the location To</option>
                                                                                        @foreach($locations as $location)
                                                                                            <option value="{{$location->id}}">{{$location->name}}</option>
                                                                                        @endforeach
                                                                                    </select>
                                                                            ...
                                                                            <div class="col-xxl-6">
                                                                                <div>
                                                                                    <label for="lastName" class="form-label">Total Seats</label>
                                        ...
                                        <table class="table table-nowrap align-middle table-borderless mb-0">
                                            ...
                                            @foreach ($trips as $key=>$trip)
                                                <tr>
                                                    ...
                                                    <td>{{$trip->transection_no}}</td>
                                                    <td>{{$trip->date}}</td>
                                                    <td>{{$trip->bus->name ?? 'N/A'}}</td>
                                                    <td>{{$trip->locationFrom->name ?? 'N/A'}}</td>
                                                    <td>{{$trip->locationTo->name ?? 'N/A'}}</td>
